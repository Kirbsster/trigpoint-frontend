            ...
            rx.card(
                rx.vstack(
                    ...
                    rx.vstack(
                        ...
                        rx.upload(
                            # children passed once (positional)
                            rx.box(
                    ...
                    # Show selected file name(s) (optional)
                    rx.cond(
                        rx.selected_files(upload_id) != [],
                        rx.text("File selected", size="2"),
                    ),
                    ...
                    # Save button – passes uploaded files into BikeState.save_bike
                    rx.button(
                        "Save bike",
                        on_click=BikeState.save_bike(
                            rx.upload_files(upload_id)
                        ),
